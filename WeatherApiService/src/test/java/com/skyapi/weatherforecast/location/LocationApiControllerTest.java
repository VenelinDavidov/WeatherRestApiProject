...
public class LocationApiControllerTest {
	...
	@Test
	public void testValidRequestBodyLocationCodeNotNull() throws Exception {
		Location location = new Location();
	...
	@Test
	public void testValidRequestBodyLocationCodeLength() throws Exception {
		Location location = new Location();
	    location.setCode("");
		location.setCityName("New York City");
		location.setRegionName("New York");
	...
	@Test
	public void testValidRequestBodyAllFieldsInvalid() throws Exception {
		Location location = new Location();
	   	location.setRegionName("");
		String bodyContend = mapper.writeValueAsString(location);

		MvcResult mvcResult = mockMvc.perform(post(END_POINT_PATH).contentType("application/json").content(bodyContend))
				.andExpect(status().isBadRequest())
				.andExpect(content().contentType("application/json"))
				.andDo(print())
				.andReturn();
